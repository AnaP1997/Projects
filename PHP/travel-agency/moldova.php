...
<head>
    ...
    background-image:url('moldova.jpg');
...
<body>
    ...
    <div class="moldova" id="moldova" style="display:flex;flex-direction:row; background-color:#edf2f4;opacity:0.6;text-align: center;">
    <?php
$result = mysqli_query($c,$sql);
