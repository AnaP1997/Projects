<?php
$c =mysqli_connect('localhost','root','','dream');session_start();
...
<body>
    ...
    ?>
    <h1 style="margin-left:650px;color:#ccd5ae;"><?= $row['login'] ?></h1>
    <a style="text-decoration: none; color:#ccd5ae;margin-left:100px;font-size:18px;" href="./logout.php">Logout</a>
    </div>
    ...
    <div class="switzerland" id="switzerland" style="display:flex;flex-direction:row; background-color:#edf2f4;opacity:0.8;text-align: center;">
    <?php
$result = mysqli_query($c,$sql);
