...
<body>
    ...
    <div class="greece" id="greece" style="display:flex;flex-direction:row; background-color:#edf2f4;opacity:0.7;text-align: center;">
    <?php
$result = mysqli_query($c,$sql);
...
?>
    ...
    <div class="f" style="margin-left:400px;">
    <?php
